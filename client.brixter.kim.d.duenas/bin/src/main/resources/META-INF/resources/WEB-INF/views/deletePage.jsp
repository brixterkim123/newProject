...
<table id="content"
	...
	<center>
			<font size="3.5"
				style="font-family: Calibri, Garamond, Serif; color: #D2691E;">Admin: Delete User </font>
		...
		<div class="col-sm-12" style="width:1000px">
			...
			<button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure?')" style="width:100px">Delete</button>
		</div>
		</center>
