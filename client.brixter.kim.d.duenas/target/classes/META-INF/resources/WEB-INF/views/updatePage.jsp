...
<table id="content"
	...
	<button class="btn btn-primary"><span><i class="glyphicon glyphicon-circle-arrow-left"></i></span>&nbspBack</button>
	</form>
	...
	<center>
		...
		<div class="" style="width:1000px">
			...
			<button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure?')" style="width:100px"><span><i class="glyphicon glyphicon-floppy-saved"></i></span>&nbspUpdate</button>
		</div>
		</center>
